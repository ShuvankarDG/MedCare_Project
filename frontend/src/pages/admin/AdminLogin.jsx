    ...
    try {
      if (state === "Admin") {
        ...
        if (data.success) {
          ...
          toast.error(
            data.message ||
              "Invalid credentials — check ADMIN_EMAIL & ADMIN_PASSWORD in .env",
          );
        }
      } else {
      ...
      if (err.code === "ERR_NETWORK")
        toast.error("Cannot reach backend — is it running on port 4000?");
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      ...
      >
        ...
        <p className="text-sm text-gray-400 mb-6">
          {state === "Admin"
            ? "Credentials from your backend .env file"
            : "Your registered doctor account"}
        </p>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              type="email"
              placeholder={
                state === "Admin" ? "admin@MedCare.com" : "doctor@example.com"
              }
        ...
        {state === "Admin" && (
          <div className="mt-4 p-3 bg-blue-50 rounded-xl border border-blue-100">
            <p className="text-xs text-blue-600 font-medium">
              💡 Set{" "}
              <code className="bg-blue-100 px-1 rounded">ADMIN_EMAIL</code> and{" "}
              <code className="bg-blue-100 px-1 rounded">ADMIN_PASSWORD</code>{" "}
              in your backend{" "}
